...
public class PGLURCCMImplTest {
	 ...
	 *
	 *  @InjectMocks
	 *  private PGLURCCMImpl pgluRCCM = new PGLURCCMImpl() {
	 *  	@Override
	...
	public void executeTest(){
		...
		pgluRCCM.execute();
		Assert.assertEquals(0, pgluRCCM.getAdviceList().size());
	}
}
